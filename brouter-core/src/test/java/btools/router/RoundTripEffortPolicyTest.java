...
import btools.router.RoundTripEffortPolicy.LengthClass;
import btools.router.RoundTripEffortPolicy.Preset;
import btools.router.RoundTripEffortPolicy.ProfileClass;
