...
public class RoundTripQualityGateTest {
  ...
  public void rejectsBeelineMarkedWaypoint() {
    OsmTrack t = squareLoop(5000);
    RoundTripFixture.markDirectWaypoint(t);
    String reason = validate(t, 20000, "fastbike");
    assertNotNull(reason);
  ...
  public void pathWithAsphaltSurfaceIsNotHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=path surface=asphalt", 1.5f);
  ...
  public void pathWithPavedSurfaceIsNotHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=footway surface=paved", 1.5f);
  ...
  public void pathWithoutSurfaceTagStaysHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=path", 1.5f);
  ...
  public void pathWithGravelSurfaceStaysHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=path surface=gravel", 1.5f);
  ...
  public void pathWithPebblestoneSurfaceIsNotHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=path surface=pebblestone", 15.0f);
  ...
  public void footwayWithCobblestoneSurfaceIsNotHostile() {
    MessageData m = RoundTripFixture.messageData("highway=footway surface=cobblestone", 15.0f);
  ...
  public void pebblestoneTrackWithoutPoorTracktypeIsNotHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=track surface=pebblestone", 15.0f);
  ...
  public void pebblestoneGrade2TrackStaysHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=track surface=pebblestone tracktype=grade2", 10.0f);
  ...
  public void pebblestonePathWithBicycleNoStaysHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=path surface=pebblestone bicycle=no", 15.0f);
  ...
  public void grade3HardSurfacePathStaysHostileHighCost() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=path surface=asphalt tracktype=grade3", 15.0f);
  ...
  public void grade2HardSurfacePathStaysHostileLowCost() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=path surface=asphalt tracktype=grade2", 1.5f);
  ...
  public void plainTrackWithAsphaltSurfaceIsNotHostile() {
    ...
    // OSM under-tagging.
    MessageData m = RoundTripFixture.messageData("highway=track surface=asphalt", 1.5f);
  ...
  public void pavedGrade1BicycleTrackIsNotHostile() {
    MessageData m = RoundTripFixture.messageData("highway=track surface=asphalt tracktype=grade1 bicycle=yes", 1.5f);
  ...
  public void pavedGrade1CycleRouteTrackIsNotHostileEvenWithHighCost() {
    MessageData m = RoundTripFixture.messageData("highway=track surface=asphalt tracktype=grade1 route_bicycle_lcn=yes", 8.0f);
  ...
  public void pavedGrade2BicycleTrackStaysHostileForRoadBike() {
    MessageData m = RoundTripFixture.messageData("highway=track surface=asphalt tracktype=grade2 bicycle=yes", 1.5f);
  ...
  public void pavedGrade1TrackWithoutBicycleTagIsNotHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=track surface=asphalt tracktype=grade1", 1.5f);
    assertFalse("paved grade1 track without explicit restriction must be acceptable: "
      + m.getWayKeyValues(), RoundTripQualityGate.isHostileForPavedProfile(m));
  }
  ...
  public void pavedGrade1TrackWithFootPermissiveIsNotHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=track surface=asphalt tracktype=grade1 foot=permissive", 1.5f);
  ...
  public void pavedGrade1TrackWithBicycleNoStaysHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=track surface=asphalt tracktype=grade1 bicycle=no", 1.5f);
  ...
  public void pavedGrade1TrackWithAccessPrivateStaysHostile() {
    MessageData m = RoundTripFixture.messageData("highway=track surface=asphalt tracktype=grade1 access=private", 1.5f);
  ...
  public void grade1TrackOnCycleNetworkWithoutSurfaceIsNotHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=track tracktype=grade1 route_bicycle_lcn=yes", 1.5f);
  ...
  public void grade1TrackOnRegionalCycleNetworkIsNotHostile() {
    MessageData m = RoundTripFixture.messageData("highway=track tracktype=grade1 route_bicycle_rcn=yes", 1.5f);
  ...
  public void grade1TrackWithoutCycleNetworkOrSurfaceStaysHostile() {
    ...
    // signal.
    MessageData m = RoundTripFixture.messageData("highway=track tracktype=grade1", 1.5f);
  ...
  public void grade2CycleNetworkTrackStaysHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=track surface=compacted tracktype=grade2 route_bicycle_lcn=yes", 1.5f);
  ...
  public void cobblestoneIsNotHostile() {
    ...
    MessageData m = RoundTripFixture.messageData("highway=residential surface=cobblestone", 1.5f);
  ...
  public void pebblestoneIsNotHostile() {
    MessageData m = RoundTripFixture.messageData("highway=residential surface=pebblestone", 1.5f);
  ...
  private static MessageData msgSinglePass(float costfactor) {
    return RoundTripFixture.messageData(null, costfactor);
  }
