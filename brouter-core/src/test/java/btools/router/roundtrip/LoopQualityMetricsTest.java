...
public class LoopQualityMetricsTest {
  ...
  private static MessageData tagged() {
    return RoundTripFixture.messageData("highway=track surface=gravel", 1.5f);
  }
  ...
  private static OsmPathElement nodeWithTags(int ilon, int ilat, String wayKeyValues) {
    ...
    MessageData msg = RoundTripFixture.messageData(wayKeyValues, 0f);
    n.message = msg;
    return n;
  }
  ...
  public void crossings_bridgeOrTunnelEdgeIsExempt() {
    ...
    MessageData md = RoundTripFixture.messageData("highway=secondary bridge=yes", 0f);
    ...
    t.nodes.get(5).message = RoundTripFixture.messageData("highway=secondary tunnel=yes", 0f);
