...
public final class RoundTripFixture {
  ...
  /** MessageData fixture — sets the package-private fields the round-trip tests need. */
  public static MessageData messageData(String wayKeyValues, float costfactor) {
    MessageData m = new MessageData();
    m.wayKeyValues = wayKeyValues;
    m.costfactor = costfactor;
    return m;
  }

  /** Mark {@code track} as routed through one DIRECT (beeline) waypoint. */
  public static void markDirectWaypoint(OsmTrack track) {
    track.matchedWaypoints = new ArrayList<>();
  ...
  public static RoutingEngine dummyRoundTripEngine(String profile, double searchRadius) {
    ...
    rctx.localFunction = profileFile(profile).getAbsolutePath();
    RoutingEngine re = new RoutingEngine(null, null, segmentDir(), wplist, rctx,
